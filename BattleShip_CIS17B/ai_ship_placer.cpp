    ...
    ships.resize(5);
        ...
        while (i != 5){
            ...
            if (tempShip.getBadPlacement()){
                if(debugging){ qDebug() << "Placement of the " << index2ShipName(i) << " was off the grid. Try again!";}
            ...
            if (coordinates.size() > 0){
                ...
                if (rePlaceShip){
                    if(debugging){ qDebug() << "Placement of the " << index2ShipName(i) << " was on top of another ship. Try again!"; }
